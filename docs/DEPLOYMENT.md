...
- **`lf` v0.2.2 released** — binaries, `install.sh`, aur Homebrew formula sab live public repo (`Rohit94r/layerflow-releases` + `Rohit94r/homebrew-tap`) pe hain. `brew install Rohit94r/tap/lf` aur `curl | bash` dono abhi public mein resolve karte hain. (v0.1.0 was the first release; v0.2.0 adds the full-screen TUI; v0.2.1 shipped the universal installer; v0.2.2 adds auto model selection so chat works out of the box.)
...
- Version badge: `https://img.shields.io/github/v/release/Rohit94r/layerflow-releases` → `v0.2.2` (live).
