      ...
      <div className="space-y-5">
          ...
          <PanelBody className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2">
              <Button
                ...
                icon={saved === "Profile saved" ? <Check className="h-3.5 w-3.5" /> : undefined}
              >
        ...
        <Panel>
          ...
          <PanelBody className="space-y-3">
            ...
            <Button
              size="sm"
              onClick={() => save("Notification prefs saved")}
              icon={saved === "Notification prefs saved" ? <Check className="h-3.5 w-3.5" /> : undefined}
            >
        ...
        <Panel>
          ...
          <PanelBody className="space-y-4">
            <div className="flex items-center justify-between gap-4 rounded-xl border border-border bg-surface-2/40 p-4">
              <span>
              ...
              <Switch label="Private mode" checked={privateMode} onCheckedChange={setPrivateMode} />
            </div>
