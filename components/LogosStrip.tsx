    ...
    <div className="flex shrink-0 items-center gap-0 pr-16">
      {providers.map((p) => (
        <img
          ...
          src={p.src}
          alt={p.name}
          className="logo-mono inline h-12 w-auto mx-12 object-contain sm:h-14 sm:mx-14"
          loading="lazy"
        />
      ))}
    </div>
...
export default function LogosStrip() {
  return (
    <section className="relative w-full border-y border-border py-16 sm:py-20 overflow-hidden">
