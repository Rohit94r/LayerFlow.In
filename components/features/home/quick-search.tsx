    ...
    <form onSubmit={onSubmit} className="w-full max-w-xl">
      ...
      <div className="group relative">
        ...
        <input
          ...
          className="h-12 w-full rounded-2xl border border-border bg-surface/60 pl-11 pr-4 text-sm text-ink placeholder:text-faint outline-none transition-colors focus:border-brand focus:bg-surface"
        />
      </div>
    </form>
  );
