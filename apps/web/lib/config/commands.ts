...
export const COMMANDS: CommandItem[] = [
  ...
  { id: "chat", label: "Chat", hint: "T", keywords: ["code", "cli", "thread"], href: "/chat" },
  { id: "terminal", label: "Terminal", hint: "Y", keywords: ["cli", "remote", "device", "command"], href: "/terminal" },
  { id: "agents", label: "Agents", hint: "A", keywords: ["runs", "worker", "automation"], href: "/agents" },
  ...
  { id: "toggle-theme", label: "Toggle theme", hint: "Switch dark / light", action: "toggle-theme" },
  {
    ...
    hint: "curl -fsSL https://layerflow.dev/install | bash",
