...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    price: "$5",
    period: "/month",
    description: "For anyone who wants real AI spend control without markup.",
    features: [
  ...
  },
  {
    ...
    price: "$14",
    period: "/month",
    description: "Teams that need central spend control and shared keys.",
    features: [
      "Everything in Starter",
      "Team billing and shared budget caps",
      "Central key vault with roles",
      "Usage history exports (CSV / JSON)",
      "Priority support",
    ],
    cta: "Go Pro",
    href: "/sign-in",
