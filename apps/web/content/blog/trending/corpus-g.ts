...
export const corpusG: BlogPost[] = [
  ...
  },
  {
    ...
    "title": "AI-Powered Customer Interviews: Research, Analysis, and Personas",
    "metaTitle": "AI-Powered Customer Interviews & Research",
    "description": "How to use AI for customer research: AI-powered customer interviews, interview analysis, survey synthesis, and building personas without a huge budget.",
    "publishedAt": "2026-08-23",
    "category": "Use cases",
    "tags": ["customer research", "AI research", "personas"],
    "primaryKeyword": "AI-powered customer interviews",
    "secondaryKeywords": ["AI for customer research", "interview synthesis AI", "customer personas", "customer interview analysis", "AI research interviewer"],
  ...
  },
  {
    ...
    "title": "How to Validate LLM Output: JSON Schema, Zod, and Retries",
    "metaTitle": "Validate LLM Output | JSON Schema, Zod Checks & Retries",
    "description": "How to validate LLM output against schemas: JSON Schema and Zod-style checks, handling malformed responses, and retry logic that doesn't blow your budget.",
    "publishedAt": "2026-08-24",
  ...
  },
  {
    ...
    "title": "Multi-Provider LLM Routing: Abstraction, Failover, and Model Swapping",
    "metaTitle": "Multi-Provider LLM Apps | Routing, Abstraction & Failover",
    "description": "Build apps that route across multiple LLM providers: abstraction layers, model routing for cost and quality, and failover that keeps you online.",
    "publishedAt": "2026-08-24",
    "category": "AI gateway",
