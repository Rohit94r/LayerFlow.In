...
export const corpusA1: BlogPost[] = [
  {
    ...
    "title": "MCP Guide: Your First Model Context Protocol Server, Explained",
    "metaTitle": "Model Context Protocol MCP Guide: First Server Explained",
    "description": "Model Context Protocol (MCP) guide for your first server: how MCP standardizes LLM tool access, how MCP servers work, and when to use it in 2026.",
  ...
  },
  {
    ...
    "title": "LLM Prompt Injection: What It Is, Examples, and How to Defend",
    "metaTitle": "LLM Prompt Injection Security: Examples & Defenses",
    "description": "LLM prompt injection attacks explained with real examples, plus practical defenses: input sanitization, tool permissions, and layered system prompts.",
    "publishedAt": "2026-08-09",
  ...
  },
  {
    ...
    "title": "Prompt Engineering vs Fine Tuning: When to Do Which",
    "metaTitle": "Prompt Engineering vs Fine Tuning | LLM Guide",
    "description": "Prompt engineering vs fine tuning: compare cost, quality, and effort. Learn when prompt engineering pays off and when fine-tuning (or RAG) is enough.",
    "publishedAt": "2026-08-10",
    "category": "Model comparison",
    "tags": ["fine-tuning", "prompt engineering", "model optimization"],
    "primaryKeyword": "prompt engineering vs fine tuning",
  ...
  },
  {
    ...
    "title": "Function Calling LLM: A Practical Guide to Tools and APIs",
    "metaTitle": "Function Calling LLM: Tools & API Best Practices",
