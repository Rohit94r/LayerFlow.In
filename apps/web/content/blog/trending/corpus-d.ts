...
export const corpusD: BlogPost[] = [
  ...
  },
  {
    ...
    "title": "LLM Chatbot REST API Integration: A Practical Playbook",
    "metaTitle": "LLM Chatbot REST API Integration Playbook",
    "description": "Integrating an LLM chatbot REST API into your app: streaming responses, conversation history, auth and tenancy, moderation, and cost control that survives real traffic.",
    "publishedAt": "2026-08-17",
    "category": "AI gateway",
  ...
  },
  {
    ...
    "title": "Prompt Evaluation Metrics Explained: How to Measure Your Prompts",
    "metaTitle": "Prompt Evaluation Metrics Explained (2026)",
    "description": "Prompt evaluation metrics explained: how to measure prompts for accuracy, faithfulness, and format compliance — plus cost and latency — in a lightweight eval harness.",
    "publishedAt": "2026-08-17",
