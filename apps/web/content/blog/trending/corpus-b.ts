...
export const corpusB: BlogPost[] = [
  {
    ...
    "title": "Prompt Caching: Add a Caching Layer to Cut LLM Costs Without Cutting Quality",
    "metaTitle": "Prompt Caching Layer | Reduce LLM Costs (2026)",
    "description": "Prompt caching explained: how API caching layers work, when a caching layer saves money, and how to design prompts so you cache more and pay less.",
  ...
  },
  {
    ...
    "title": "Context Window Optimization: Techniques for Using Every Token Wisely",
    "metaTitle": "Context Window Optimization Techniques | LLM Tokens",
    "description": "Context window optimization techniques: pack more useful information, trim noise, and use the context window efficiently to improve answers and cut token costs.",
    "publishedAt": "2026-08-12",
    "category": "Prompt engineering",
  ...
  },
  {
    ...
    "title": "Best LLM Gateway: 2025-2026 Comparison of Top AI Gateways",
    "metaTitle": "Best LLM Gateway Comparison 2025-2026",
    "description": "Best LLM gateway comparison for 2025 and 2026: unified APIs, load balancing, budgets, and key management. How to pick an LLM gateway for your team.",
    "publishedAt": "2026-08-13",
    "category": "AI gateway",
    "tags": ["LLM gateway", "AI API gateway", "model gateway"],
    "primaryKeyword": "best LLM gateway",
    "secondaryKeywords": ["LLM gateway comparison", "best LLM gateways 2026", "AI gateway tools", "model gateway"],
    "readingTime": "7 min read",
    "author": "LayerFlow Team",
  ...
  },
  {
    ...
    "title": "OpenRouter vs LiteLLM: Which LLM Router Should You Use?",
    "metaTitle": "OpenRouter vs LiteLLM | Best LLM Router for Your Stack",
    "description": "OpenRouter vs LiteLLM compared: hosted routing vs self-hosted SDK, pricing, features, and which LLM router fits your team's AI stack in 2026.",
    "publishedAt": "2026-08-13",
    "category": "AI gateway",
