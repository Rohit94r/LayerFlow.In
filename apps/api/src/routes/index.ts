...
import { collectionsRouter } from "./legacy/community/collections";
import { promptCloneRouter } from "./legacy/community/clone";
import { reportsRouter } from "./report/report";
import { followsRouter, profilesRouter } from "./legacy/community/profiles";
import { commentsRouter, likesRouter } from "./legacy/community/social";
import { compareRouter } from "./legacy/compare/compare";
...
import { learningRouter } from "./legacy/learning/learning";
import { memoryRouter } from "./legacy/memory/memories";
import { notificationsRouter } from "./notifications/notifications";
import { promptsRouter } from "./prompts/prompts";
import { rescueRouter } from "./legacy/rescue/rescue";
import { improveRouter } from "./improve/improve";
import { agentsRouter } from "./legacy/agents/agents";
import { builderRouter } from "./legacy/agents/builder";
import { chatRouter } from "./chat/chat";
import { modelsRouter } from "./models/models";
import { runsRouter } from "./legacy/runs/runs";
import { searchRouter, similarRouter } from "./search/search";
import { sessionsRouter } from "./sessions/sessions";
import { audioRouter } from "./legacy/audio/audio";
...
import { autosubmitRouter } from "./legacy/autosubmit/autosubmit";
